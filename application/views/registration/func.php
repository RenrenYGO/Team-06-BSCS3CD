...
<script type="text/javascript">
    ...
    function invalid(){
        $('#autoclosable-btn-invalid').prop('disabled', true);
        $('.alert-autocloseable-invalid').show();

        $('.alert-autocloseable-invalid').delay(3000).fadeOut( 'slow', function() {
            // Animation complete.
            $('#autoclosable-btn-invalid').prop('disabled', false);
        });
    }
